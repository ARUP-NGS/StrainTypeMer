...
def get_args():
    ...
    matrix_text = args.matrix
    output = args.output

    return matrix_text, output
...
def generage_matrix(x_labels, y_labels, data, output):
...
def main():
    matrix_text, output = get_args()
    x_labels, y_labels, data = parse_text(matrix_text)
    generage_matrix(x_labels, y_labels, data, output)
